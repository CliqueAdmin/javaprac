 ...
 * Example 1:
 * <p>
 * Input: prices = [7,1,5,3,6,4] Output: 7 Explanation: Buy on day 2 (price = 1) and sell on day 3 (price =
 ...
 * profit = 5-1 = 4. Note that you cannot buy on day 1, buy on day 2 and sell them later, as you are engaging
 * multiple transactions at the same time. You must sell before buying again. Example 3:
 * <p>
 * Input: prices = [7,6,4,3,1] Output: 0 Explanation: In this case, no transaction is done, i.e., max profit =
 * 0.
 */
public class BestTimeToBuyStockII {

  public static void main(String[] args){
    BestTimeToBuyStockII q = new BestTimeToBuyStockII();
    //q.solution()
  }
